...
**Ultimo aggiornamento: 9 settembre 2026. Stato: revisione della 0.1.5 inclusa nel commit `10123b5` con invalidazione delle sorgenti residenti, recupero grafico bounded, riconoscimento NEF, ammissione RAW verificata sui 30 NEF a 2 GiB e cancellazione dei lavori abbandonati durante la navigazione. Specifica anteprime e ADR integrati nell’architettura della cartella progetto. Il commit `10123b5` è presente su `origin/main`, verificato in rete il 9 settembre; i precedenti `1b98b4f` ed `e609310` restano riferimenti storici. Prove e limiti sono elencati sotto. Qualifica integrata e gate R0–R4 aperti.**
...
| §7 — RAW | Sviluppo completo Apple CIRAWFilter isolato, ricetta TR-linear-v1 e provenienza; DNG Bayer senza preview verificato; riconoscimento NEF/TIFF corretto e 30 NEF Nikon D750 verificati a risoluzione nativa entro il budget di 2 GiB | **Parziale, anticipazione macOS.** Mancano LibRaw isolato/versionato, matrice reale camere/CFA, controllo completo WB/matrici, confronto ricette, gestione distinta della preview e prove Windows. Non si dichiara supporto universale RAW. Demosaicing proprio e ricerca §7.3 restano post-v1. |
