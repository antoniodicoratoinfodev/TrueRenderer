...
| Verifica | 32 test Rust, 6 prove IPC, 19 fixture esterne e 6 controlli aggiuntivi; 24 casi sinusoidali; nuove schermate RAW/JPEG/griglia | Pacchetto finale verificato; estendere target e corpus |
| GPU | Apple M4/Metal: 4.096 campioni, errore massimo 9,54e-7 contro soglia 1e-4 | ICC/LUT, display e recovery non qualificati |
| Pacchetto | 0.1.3 release arm64 con due servizi XPC; firma/hash, Finder e copia autonoma verificati; 0.1.2 conservata | Firma di distribuzione e target Windows in R4 |
...
| §11 — gigapixel/tile/cache | Piramide CPU residente per sorgenti entro 64 Mi pixel; cache limitate per anteprima | **Mancante in R3.** TileProvider, TIFF nativo piramidale, provenienza SubIFD, cache persistente/spool, GC e invalidazione, generazione cancellabile, prefetch/residenza GPU, prova 4 Gpx. La piramide attuale in RAM non equivale al sistema gigapixel. |
