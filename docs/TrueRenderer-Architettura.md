...
**Ultimo aggiornamento: 8 settembre 2026. Stato: TrueRenderer 0.1.5 installato e verificato sul Mac; anteprime Standard/Piena, residenza autonoma, budget, cache v2 asincrona e compute GPU implementati. 62 test Rust passati. Modifiche locali non ancora pubblicate; repository con licenza proprietaria. Qualifica integrata del progetto e gate R0–R4 aperti.**
...
| Verifica | 62 test Rust, 6 prove IPC, 24 casi sinusoidali; cache lossless, lease, deduplica e confronto compute | Qualifica integrata e corpus reale |
| GPU | Apple M4/Metal: 1.593.672 canali lineari conformi e altrettanti sRGB8 entro un livello; A/B dello stadio renderer favorevole nei due casi provati | Latenza integrata, ICC/LUT, display e recovery non qualificati |
