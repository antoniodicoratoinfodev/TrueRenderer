...
**LibRaw non richiede un acquisto per vendere l'applicazione.** La versione open source può essere
usata in un prodotto proprietario commerciale rispettando CDDL 1.0 oppure LGPL 2.1. La CDDL è
l'opzione candidata: richiede sorgenti del componente coperto, eventuali modifiche, licenza e
notice; non impone di aprire tutto il codice indipendente dell'applicazione. La build 0.1.5 usa
CIRAWFilter e non incorpora LibRaw. Fonti ufficiali e obblighi: [verifica LibRaw](licenza-libraw.md).

**L'integrazione LibRaw rimane un gate di distribuzione.** Il progetto ufficiale offre opzioni CDDL e
