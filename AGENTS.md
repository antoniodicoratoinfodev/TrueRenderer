...
- Aggiornare durante lo sviluppo cosa è implementato, verificato, aperto e mancante in `docs/avanzamento.md`; aggiornare le caselle del piano ed eseguire `python3 scripts/sync-docs.py` per riportare registro e specifica anteprime anche in `TrueVision-Architettura.md`, ora nella radice del progetto. Non ricreare la vecchia copia sul Desktop.
